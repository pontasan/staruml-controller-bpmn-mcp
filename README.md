...
4. The HTTP server starts — all BPMN Diagram tools become available via MCP
...
```bash
claude mcp add staruml-bpmn node /absolute/path/to/staruml-controller-bpmn-mcp/dist/index.js
```
